...
void DS1307_SetRegByte(uint8_t regAddr, uint8_t val) {
	...
	cyhal_i2c_master_write(&i2c_master_obj, 0x68u, bytes,2,1000 ,true);
}
...
uint8_t DS1307_GetRegByte(uint8_t regAddr) {
	uint8_t val;
	cyhal_i2c_master_write(&i2c_master_obj, 0x68u, &regAddr ,1,1000 , true);
	cyhal_i2c_master_read(&i2c_master_obj,0x68u , &val, 1,1000 ,false);
	return val;
}

...
/*********************************************************************
*
*       ID_SCREEN_05__APPW_NOTIFICATION_INITDIALOG
*/
void ID_SCREEN_05__APPW_NOTIFICATION_INITDIALOG(APPW_ACTION_ITEM * pAction, WM_HWIN hScreen, WM_MESSAGE * pMsg, int * pResult) {
